/**
 * pediNutrition.js — MiNutriQ Pediatric Nutrition Module
 * ─────────────────────────────────────────────────────────────────────────
...
function fentonRenderResults(R) {
  ...
  el.innerHTML = `
    ...
    <div style="display:flex;gap:10px;flex-wrap:wrap;margin-bottom:28px">
      ...
      <button class="print-btn" onclick="saveToPDF('pedi-results','MiNutriQ — Pediatric Nutrition Report')" style="color:#60a5fa;border-color:rgba(96,165,250,.3)">📄 Save PDF</button>
...
function fentonExport() {
  ...
  const blob = new Blob([
    '═══════════════════════════════════════\n',
    '  MINUTRIQ — FENTON 2013 GROWTH REPORT\n',
    '═══════════════════════════════════════\n',
    `Generated: ${new Date().toLocaleString()}\n\n`,
    txt.replace(/\s{3,}/g, '\n').trim(),
    '\n\n─────────────────────────────────────────\n',
    'Source: Fenton TR, Kim JH. BMC Pediatrics 2013;13:59\n',
    'Generated by MiNutriQ\n',
  ], { type:'text/plain' });
